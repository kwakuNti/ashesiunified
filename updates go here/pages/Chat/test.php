...
include '../../backend/actions/getmessage.php';
...
<div class="wrapper">
    <div class="container">
        <div class="left">
            ...
            <ul class="people">
            <?php include '../../backend/functions/ODIP.php';?>
...
you blind bitch</span>
        ...
        <div class="right">
            ...
            <div class="chat" data-chat="<?php echo $recipient_id; ?>">
            <?php foreach ($messages_data as $message): ?>
        <div class="conversation-start">
        <span><?php echo $message['formatted_timestamp']; ?></span>
        </div>
        <div class="bubble <?php echo ($message['sender_id'] == $_SESSION['user_id']) ? 'you' : 'me'; ?>">
    ...
    <form id="message-form" action="../../backend/actions/send_message_action.php" method="post" style="display: contents;" class="m">
...
searchInput.addEventListener('input', function() {
    ...
    let peopleList = document.querySelectorAll('.left .person');
    
    peopleList.forEach(person => {
        let personName = person.querySelector('.name').innerText.toLowerCase();
        
        if (personName.includes(searchTerm)) {
            person.style.display = 'flex'; // Show person if their name matches search term
        } else {
            person.style.display = 'none'; // Hide person if their name does not match search term
        }
    });
});
</script>
