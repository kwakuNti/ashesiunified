...
<body>
    <div class="wrapper">
        <form action="../../backend/actions/register_user_action.php" method="post" id="registerForm" name="registerForm">
            <h1>Register</h1>
            <div class="input-box">
            ...
            <div class="input-box">
                <input type="email" placeholder="Email" name="email" id="emailx" required pattern="^[a-zA-Z0-9._%+-]+@aucampus\.onmicrosoft\.com$" title="Please enter a valid email address ending with @aucampus.onmicrosoft.com">
                <i class='bx bx-mail-send'></i>
            </div>
